          ...
          <div className="max-w-4xl mx-auto">
            ...
            {schedule[selectedDay] && schedule[selectedDay].length > 0 ? (
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                      <div className="flex-1">
                        ...
                        <p className="text-xl text-gray-300 mt-1 font-semibold">{entry.class}</p>
              ...
              <div className="bg-gray-800 rounded-lg p-12 text-center">
                ...
                <p className="text-xl text-gray-300 mb-2">No hay clases programadas para {selectedDay}</p>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mt-12">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Clases Semanales</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Acceso App</div>
              </div>
            </div>
          </div>
            ...
            >
              {planes.map((plan, index) => (
                ...
                >
                  {/* Glow effect */}
                  {plan.popular && (
                    <div className="absolute -inset-1 bg-gradient-to-r from-avc-red via-red-500 to-avc-red rounded-2xl opacity-75 group-hover:opacity-100 blur transition duration-1000 group-hover:duration-200"></div>
                  )}
                  ...
                  <div className={`relative bg-gradient-to-br ${
                    ...
                    {plan.popular && (
                      <div className="absolute -top-5 left-1/2 transform -translate-x-1/2 z-20">
                        <div className="bg-gradient-to-r from-avc-red to-red-600 text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg animate-pulse">
                          ⭐ MÁS POPULAR
                        </div>
                      </div>
                    )}
                    ...
                    {/* Plan Name */}
                    <h3 className="text-3xl font-bold text-white mb-3 text-center">{plan.name}</h3>
                    ...
                    <Link
                      ...
                      className={`block text-center font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 ${
                        plan.popular
                          ? 'bg-gradient-to-r from-avc-red to-red-600 hover:from-red-600 hover:to-avc-red text-white shadow-lg shadow-avc-red/50'
            ...
            <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-8 border border-gray-700">
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  ...
                  <h4 className="text-white font-semibold mb-2">Sin Permanencia</h4>
                  <p className="text-gray-400 text-sm">Cancela cuando quieras, sin penalizaciones</p>
                </div>
                <div>
                  <div className="text-4xl mb-3">💳</div>
                  <h4 className="text-white font-semibold mb-2">Pago Flexible</h4>
                  <p className="text-gray-400 text-sm">Efectivo, tarjeta o transferencia</p>
                </div>
                <div>
                  <div className="text-4xl mb-3">🎁</div>
                  <h4 className="text-white font-semibold mb-2">Clase Gratis</h4>
                  <p className="text-gray-400 text-sm">Prueba antes de comprometerte</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-16">
            <p className="text-gray-400 mb-6">¿Necesitas ayuda para elegir?</p>
            <Link
              href="/unete"
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-avc-red to-red-600 hover:from-red-600 hover:to-avc-red text-white font-bold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg shadow-avc-red/50"
            >
