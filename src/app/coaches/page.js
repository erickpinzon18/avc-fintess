        ...
        <div className="container mx-auto px-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              <p className="text-gray-400 text-lg">No hay coaches disponibles en este momento.</p>
            </div>
          ) : (
            /* Grid de Coaches */
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {coaches.map((coach) => (
                <div
                  ...
                  className="bg-gray-800 rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-700 hover:border-avc-red cursor-pointer"
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-400 text-sm line-clamp-3">{coach.bio}</p>
        ...
        >
          ...
          >
            <div className="relative">
              ...
              {/* Contenido */}
              <div className="p-8">
                <h2 className="text-4xl font-bold text-white mb-2">{selectedCoach.name}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  {selectedCoach.experience && (
                    <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                      ...
                      <p className="text-gray-300">{selectedCoach.experience}</p>
                    </div>
                  )}
                  ...
                  {selectedCoach.favoriteExercise && (
                    <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                      <div className="flex items-center mb-2">
                        ...
                        <h3 className="text-white font-semibold">Ejercicio Favorito</h3>
                      </div>
                      <p className="text-gray-300">{selectedCoach.favoriteExercise}</p>
                    </div>
                  )}
                </div>
                ...
                {selectedCoach.bio && (
                  <div className="mb-8">
                    ...
                    <p className="text-gray-300 leading-relaxed">{selectedCoach.bio}</p>
                  </div>
                )}
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {selectedCoach.certifications.map((cert, idx) => (
                        <span 
                          key={idx} 
                          className="bg-avc-red bg-opacity-20 border border-avc-red text-white px-4 py-2 rounded-lg text-sm font-semibold"
                        >
                          {cert}
                        </span>
                      ))}
                ...
                {selectedCoach.achievements && (
                  <div className="mb-8">
                    ...
                    <p className="text-gray-300 leading-relaxed">{selectedCoach.achievements}</p>
                  </div>
                )}
                ...
                {selectedCoach.philosophy && (
                  <div className="mb-8">
                    ...
                    <div className="bg-gray-800 border-l-4 border-avc-red p-6 rounded-lg">
                      <p className="text-gray-300 leading-relaxed italic">&quot;{selectedCoach.philosophy}&quot;</p>
                    </div>
                  </div>
                )}
                    ...
                    <div className="flex flex-wrap gap-4">
                      {selectedCoach.email && (
                        <a
                          ...
                          className="flex items-center bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition duration-300"
                        >
                      ...
                      {selectedCoach.instagram && (
                        <a
                          ...
                          className="flex items-center bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-4 py-2 rounded-lg transition duration-300"
                        >
