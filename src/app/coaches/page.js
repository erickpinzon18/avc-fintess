                  ...
                  <div className="relative h-64">
                    {coach.image ? (
                      <Image
                        ...
                        className="object-cover"
                        style={{
                          objectPosition: coach.imagePosition 
                            ? `${coach.imagePosition.x}% ${coach.imagePosition.y}%` 
                            : '50% 50%'
                        }}
                      />
                    ) : (
              ...
              <div className="relative h-80">
                {selectedCoach.image ? (
                  <Image
                    ...
                    className="object-cover"
                    style={{
                      objectPosition: selectedCoach.imagePosition 
                        ? `${selectedCoach.imagePosition.x}% ${selectedCoach.imagePosition.y}%` 
                        : '50% 50%'
                    }}
                  />
                ) : (
                  <div className="w-full h-full bg-linear-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                    <h3 className="text-white text-5xl font-bold text-center px-4">{selectedCoach.name}</h3>
                  </div>
                )}
