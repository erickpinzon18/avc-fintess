  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <AdminHeader 
        ...
        subtitle="Administra competencias y actividades especiales"
      />
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        {/* Eventos Próximos */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Próximos Eventos ({eventosProximos.length})</h2>
          {eventosProximos.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {eventosProximos.map((evento) => (
                <div
                  key={evento.id}
                  className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-avc-red transition-all duration-300"
                >
                  {evento.image && (
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{evento.title}</h3>
                    ...
                    <p className="text-gray-700 text-sm mb-4 line-clamp-3">{evento.description}</p>
                    {evento.capacity && (
                      <p className="text-gray-600 text-xs mb-4">Capacidad: {evento.capacity} personas</p>
                    )}
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
              <p className="text-gray-600 text-lg">No hay eventos próximos</p>
            </div>
          )}
        </div>
        ...
        {/* Eventos Pasados */}
        <div>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Eventos Pasados ({eventosPasados.length})</h2>
          {eventosPasados.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {eventosPasados.map((evento) => (
                <div
                  key={evento.id}
                  className="bg-white rounded-xl border border-gray-200 overflow-hidden opacity-75 hover:opacity-100 transition-all duration-300"
                >
                  {evento.image && (
                    <div className="relative h-48 bg-gray-100">
                      <img
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 text-sm mb-4 line-clamp-2">{evento.description}</p>
                    <div className="flex space-x-2">
                      <button
                        onClick={() => handleEdit(evento)}
                        className="flex-1 bg-blue-600 hover:bg-blue-700 text-gray-900 font-semibold py-2 px-4 rounded transition duration-300"
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
              <p className="text-gray-600 text-lg">No hay eventos pasados</p>
            </div>
          )}
        </div>
      </main>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Título del Evento</label>
                <input
                  type="text"
